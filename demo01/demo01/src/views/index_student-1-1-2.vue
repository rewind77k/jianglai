<template>
    <div>
        <p>发明专利授权 5 分/项，其它知识产权不计分。专利必须以上海师范大学为第一单位，学生第一署名或者导师第一署名、学生第二署名；</p>
        <p>专利受理通知书不得作为参评成果；同一学生获得多个专利授权的，只计一项。</p>
        <!-- action="https://jsonplaceholder.typicode.com/posts/" -->
        <div>
            <el-upload
                accept=".jpg"
                action="http://127.0.0.1:8000/student/upload/?co_st_id=202"
            ...
            <el-card>
            <div class="md">
                    <img :src="getImgUrl(list[3])" class="imgM" >
                </div>
            </el-card>
